...
def new_student():
    ...
    score1 = input("plz enter student score1:")
    score2 = input("plz enter student score2:")
    score3 = input("plz enter student score3:")
    score4 = input("plz enter student score4:")
    score5 = input("plz enter student score5:")
    try:
        con = connect_db()
        cur = con.cursor()
        SQL ='''
